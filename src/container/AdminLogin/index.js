...
//       if (response) {
//         const { token, authType } = response.data;
//         setLocalStorage("authData", { authType, token });
...
//   return (
//     <div
//       className="flex min-h-screen bg-white w-full flex-col md:flex-row"
//       data-theme="light"
//     >
//       {/* Left Panel - Login Form */}
//       <div className="flex w-full flex-col  bg-white justify-center px-6 py-12 md:w-1/2 md:px-12 lg:px-20">
...
//             <button
//               type="submit"
//               className="flex w-full items-center justify-center rounded bg-blue-600 px-4 py-3 text-sm font-medium text-white hover:bg-blue-700 focus:outline-none"
//             >
//               Login
//             </button>
//           </form>
