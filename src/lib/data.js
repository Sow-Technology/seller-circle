export const blogs = [
  {
    ...
    date: "June 18",
    title:
      "Decoding the Amazon Top Search : Your Ultimate Guide to Strategic Insights",
    description:
      "Enter the Amazon Top Search Term Reports, a treasure trove nestled within Brand Analytics, designed to illuminate the intricacies of customer search behavior. Let's embark on a journey through its features, applications, and tips for maximizing its potential. ",
...
export const reviews = [
  {
    body: "SellerCircle has played a crucial role in initially helping us stabilize our Ads’ ROAS and then scaling on Amazon. Their insights, feedback, reports are one of the best in the industry. Their vast in-depth knowledge and experience with Amazon’s all forms of Ad campaigns have helped us make consistent growth on Amazon.",
    img: "/images/brands/4.png",
    name: "Vivek Shetty (Director)",
  },
  {
...
export const caseStudies = [
  {
    ...
    title:
      "How SellerCircle Drove Vooki's Festive Sales Surge with AMC, DSP & AMS",
    client: "Vooki",
    services: "AMC, DSP, AMS",
    link: "/case-studies/Vooki",
    marketplace: "Amazon.in",
  },
  {
    imageUrl: "/images/brands/11.png",
    year: "-",
    date: "-",
    category: "Hair & Skin Care",
    title:
      "How SellerCircle Drove TrueFrog's Diwali Success with targeted AMC Audience Solutions",
    client: "True Frog",
    services: "AMC Audience Solutions",
    link: "/case-studies/True-Frog",
    marketplace: "Amazon.in",
  },
  {
    imageUrl: "/images/brands/1.png",
    ...
    category: "Herbal Supplements and Juices",
    title:
      "How Sellercircle Advertising Strategic Campaigns Achieved a 90% Sales Increase and Boosted Brand Awareness in 6 months",
    client: "Krishna Herbal & Ayurveda",
    services: "DSP, PPC, Search, Sponsored Video, AMC",
    link: "/case-studies/Krishnas-Herbal-and-Ayurveda",
    marketplace: "Amazon.in",
  },
];
