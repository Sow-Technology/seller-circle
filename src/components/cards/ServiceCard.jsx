...
const ServiceCard = ({ item }) => {
  return (
    <motion.div
      ...
      className="min-w-[280px] lg:max-w-[330px] p-10 flex flex-col gap-7 rounded-2xl cshad justify-start relative z-10 bg-white flex-1 "
    >
      <h4 className="nunito font-extrabold text-2xl hover:text-background transition-all duration-300 hover:tracking-widest">
        {item.title}
      </h4>
      <p className="nunito text-xs first-letter:uppercase ">
        {item.description}
      </p>
