            ...
            <div className="text-center lg:text-left ">
              <div className="mb-10 lg:mb-0 ">
                <h1 className="mt-0 mb-3 lg:text-2xl text-xl font-bold leading-tight sm:text-4xl sm:leading-tight  md:leading-tight text-white ">
                  Ready to expand your reach across leading e-commerce
                  platforms? Contact us today to learn more about our
                  Marketplaces Advertising services and how we can help your
                  brand thrive in the competitive digital retail space.
                </h1>
