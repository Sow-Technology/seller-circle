            ...
            <div className="text-center lg:text-left ">
              <div className="mb-10 lg:mb-0 ">
                <h1 className="mt-0 mb-3 text-3xl font-bold leading-tight sm:text-4xl sm:leading-tight md:text-[40px] md:leading-tight text-white ">
                  Ready to take your brand global? Get in touch with our expert
                  consultants today to discuss your goals and start planning
                  your successful international launch.
                </h1>
