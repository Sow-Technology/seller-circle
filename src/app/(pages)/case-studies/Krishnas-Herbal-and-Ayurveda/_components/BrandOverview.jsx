    ...
    <AnimatedElement delay={0.2}>
      <div>
        <p className="text-2xl lg:text-4xl font-bold my-20 max-w-5xl mx-auto text-center">
          Krishna Ayurveda, a health-focused brand specializing in diabetic and
          wellness products, sought to scale new listings, grow the market share
          of their hero products, and optimize ad spend. SellerCircle was tasked
          with building advanced advertising strategies to boost visibility,
          conversions, and profitability on Amazon.
        </p>
      </div>
    </AnimatedElement>
